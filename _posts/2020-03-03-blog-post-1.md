...
date: 2020-03-03
permalink: /_posts/2020-03-03-blog-post-1/
tags:
  - cool posts
  - category1
  - category2
...
#  Understanding basic pattern of the data
...
#  I am going to use BERT to identify the disaster and non-disaster for test problem set.
...
#  Helper Functions:
   ...
   #  Getting BERT from the Tensorflow Hub:
         ---
         %%time
...
#  Taken tokenizer from the bert layer
       ---
...
#  Now Encoding the text into tokens, masks, and segment flags:
      ---
...
#  Predict the target using developed model
       ---
